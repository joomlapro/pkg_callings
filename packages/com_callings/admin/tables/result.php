 ...
 * @since       3.0
 */
class CallingsTableResult extends JTable
{
	/**
	 * Constructor
	 *
	...
	/**
	 * Overload the store method for the Results table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New result. A result created and created_by field can be set by the user,
		...
		$table = JTable::getInstance('Result', 'CallingsTable');
